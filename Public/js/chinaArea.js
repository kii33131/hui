...
function PCAS() {
	...
	p=arguments[0].toLowerCase();
	c=arguments[1].toLowerCase();
	a=arguments[2].toLowerCase();
	
    this.SelP = document.getElementsByName(p)[0];
    this.SelC = document.getElementsByName(c)[0];
    this.SelA = document.getElementsByName(a)[0];
