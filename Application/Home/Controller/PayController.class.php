...
class PayController extends Controller{
    ...
    public function doalipay(){
        ...
        if($pay==1){
            ...
            $this->success('您的订单已经提交成功客服会尽快与您联系','/index.php/Home/Index/index');
             exit;
    ...
    function notifyurl(){
        ...
        if($verify_result) {
           ...
           if($_POST['trade_status'] == 'TRADE_FINISHED') {
               ...
               $date['spay'] =1;
               $danhao  = $out_trade_no;
               $list = $Didan->where(array('danhao'=>$danhao))->select();
               if($list){
               		$ids = $Didan->where(array('danhao'=>$danhao))->save($date);
               		if($ids){
