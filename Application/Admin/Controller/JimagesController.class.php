...
class JimagesController extends AdminController {
	//分类列表
    ...
    //添加分类
     ...
     public function add(){
      ...
      imagezoom('Uploads/'.$filename['filename'], 'Uploads/'.$info['photo']['savepath'].'848'.$info['photo']['savename'], 848, 467, '#FFFFFF');
