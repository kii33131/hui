...
class massController extends AdminController {
    ...
    //添加分类
     ...
     public function add(){
      ...
      imagezoom('Uploads/'.$filename['filename'], 'Uploads/'.$info['photo']['savepath'].'mass'.$info['photo']['savename'], 113, 113, '#FFFFFF');

     //  $uo='Uploads/'.$info['photo']['savepath'].'99_'.$info['photo']['savepath'].$info['photo']['savename'];
